...
serviceNameLo="baka-nhatson"                                                       # service name with the first letter in lowercase
serviceName="baka-nhatson"                                                           # service name
serviceUser="root"                                                                           # OS user name for the service
serviceGroup="root"                                                                         # OS group name for the service
applDir="/tserver/java-projects/nhatson"                                       # home directory of the service application
serviceUserHome="/home/$serviceUser"                                      # home directory of the service user
serviceLogFile="/tserver/java-projects/nhatson/tmp/$serviceNameLo.log"                            # log file for StdOut/StdErr
maxShutdownTime=15                                                                     # maximum number of seconds to wait for the daemon to terminate normally
pidFile="/tserver/java-projects/nhatson/tmp/$serviceNameLo.pid"                                        # name of PID file (PID = process ID number)
javaCommand="java"                                                                       # name of the Java launcher without the path
javaArgs="-jar nhatson.jar"                                                                  # arguments for Java launcher
javaCommandLine="$JAVA_HOME$javaCommand $javaArgs"   # command line to start the Java service application
javaCommandLineKeyword="nhatson"                                   # a keyword that occurs on the commandline, used to detect an already running service process and to distinguish it from others
